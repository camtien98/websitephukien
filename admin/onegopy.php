                ...
                <div class="col-lg-12">
                    <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                        ...
                        <ul class="breadcome-menu">
                            ...
                            <li><a href="gopykhachhang.php">Danh Sách Liên Hệ</a> <span class="bread-slash">/</span>
                            </li>
                            
                            <li><span class="bread-blod">Nội Dung Liên Hệ</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sparkline8-list shadow-reset">
                        ...
                        {   
                                 $stt=$_GET['id'];
                                $query = "SELECT * FROM lien_he where id={$stt}";
                            ...
                            else
                            {
                                ...
                                <a href='gopykhachhang.php'><button class='btn btn-white btn-xs'><i class='fa fa-folder'></i> Quay Trở Lại</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="chat-main-list">
                    ...
                    <div class="chat-content chat-scrollbar">
                        <div class="author-chat">
                            <h3>Thiện Đẹp Trai :)) <span class="chat-date">10:15 am</span></h3>
                            <p>Yêu là chết ở trong lòng một ít</p>
                        </div>
                        <div class="client-chat">
                            <h3>Tuyền Xinh Gái :)) <span class="chat-date">10:10 am</span></h3>
                            <p>Vì mấy khi yêu mà chắc được yêu</p>
                        </div>
                        <div class="author-chat">
                            <h3>Thiện Đẹp Trai :)) <span class="chat-date">10:05 am</span></h3>
                            <p>Cho rất nhiều song nhận chẳng bao nhiêu</p>
                        </div>
                        <div class="client-chat">
                            <h3>Tuyền Xinh Gái :)) <span class="chat-date">10:02 am</span></h3>
