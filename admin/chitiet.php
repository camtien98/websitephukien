                        ...
                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                            ...
                            <li class="nav-item">
                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                    ...
                                    <span class="admin-name">Tiên Tiên - Thi Thi </span>
                ...
                ?>
                            ...
                            echo "<b>".$tong_lon_duoc_dinh_dang."</b>";
                              ?>  
                                ...
                                <a href='../session_admin/duyetdonhang.php?action=add&duyet=<?php echo $id?>'><button class='btn btn-white btn-xs'><i class='fa fa-get-pocket'></i> Xác Nhận Đơn Hàng</button></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copy-right">
                        <p>Copyright &#169; 2019 All rights reserved<a href="https://www.facebook.com/TTShop-495128960896483/">TT Shop</a>.</p>
                    </div>
                </div>
            </div>
        </div>
