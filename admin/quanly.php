                        ...
                        <div class="sparkline8-graph">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="name" data-editable="true">Tên Người Đặt Hàng</th>
                                            <th data-field="company" data-editable="true">Email</th>
                                            <th data-field="complete">Địa Chỉ</th>
                                            <th data-field="task" data-editable="true">Thể Loại</th>
                            ...
                            <tbody>
                                ...
                                {   $i=0;
                                    ...
                                    echo"<button class='btn btn-white btn-xs'>$trangthai</button>";
                                    echo"</div>";
                                    echo"</td>";
                                    echo"<td>$name</td>";
                                    echo"<td>$email</td>";
                                    ...
                                    echo" <a href='chitiet.php?action=add&id=$id'><button class='btn btn-white btn-xs'><i class='fa fa-pencil'></i> Xem Chi Tiết</button></a>";
                                    echo"</div>";
                                    echo" </td>";
