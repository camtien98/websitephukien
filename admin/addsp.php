...
>
                    <div class="form-group">
                        <input type="name" class="form-control" placeholder="Tên Sản Phẩm" name="txtname">
                    </div>
                    <div class="form-group">
                        <input type="phone" class="form-control" placeholder="Giá Sản Phẩm" name="txtphone">
                    </div>
                    ...
                    <div class="box_btn">
                        <button type="submit" class="btn btn-success" name="ok">Thêm Sản Phẩm</button>
                    </div>
                </form>
                <?php
...
else
{
	...
	$txthinh=basename( $_FILES["fileupload"]["name"]);
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    echo "<br>Thêm Sản Phẩm Không Thành Công";
