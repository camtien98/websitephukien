            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li><a  href="danhsachsanpham.php">Quản Lí Sản Phẩm</a>
                        </li>
                        <li><a  href="danhsachtintuc.php">Quản Lí Tin Tức</a>
                        </li>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        ...
                        <div class="sparkline8-graph">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="company" data-editable="true">Giá</th>
                                            <th data-field="complete">Hình</th>
                            ...
                            <tbody>
                                ...
                                <?php 
                                // select hóa đơn tạo trạng thái ngày đặt hàng và người mua hàng
                                // error_reporting(0);
                                ...
                                {   $i=0;
                                    ...
                                    echo"<td>$name</td>";
                                    echo"<td>$gia</td>";
                                    echo"<td class='text-center product'><img src='../$hinh' class='img-thumbnail ' width='20%'/></td>";
                                    echo"</td>";
                                    
                                    echo"<td>";
                                    echo"<div class='btn-group project-list-action'>";
                                    echo"<a href='deletesp.php?action=delete&id=$id'><button class='btn btn-danger btn-xs '><i class='fa fa-pencil'></i> Xóa Sản Phẩm </button></a>";
                                    echo"  <span>";
                                     echo"<a href='addsp.php'><button class='btn btn-success btn-xs '><i class='fa fa-pencil'></i> Thêm Sản Phẩm </button></a>";
                                       echo"<a href='update.php?action=update&id=$id'><button class='btn btn-warning btn-xs '><i class='fa fa-pencil'></i> Cập nhật Sản Phẩm </button></a>";
