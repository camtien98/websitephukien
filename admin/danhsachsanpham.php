                        ...
                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                            ...
                            <li class="nav-item">
                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                    ...
                                    <span class="admin-name"> TTShop </span>
                        ...
                        <div class="sparkline8-graph">
                            ...
                            <tbody>
                                ...
                                {   $i=0;
                                    ...
                                    echo"<a href='XoaSP.php?action=delete&id=$id'><button class='btn btn-danger btn-xs '><i class='fa fa-pencil'></i> Xóa Sản Phẩm </button></a>";
                                    echo"  <span>";
                                    echo"<a href='ThemSP.php'><button class='btn btn-success btn-xs '><i class='fa fa-pencil'></i> Thêm Sản Phẩm </button></a>";
                                    
                                       echo"<a href='SuaSP.php?action=update&id=$id'><button class='btn btn-danger btn-xs '><i class='fa fa-pencil'></i> Cập nhật Sản Phẩm </button></a>";
