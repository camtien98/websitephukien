...
<?php
 $id=$_GET['id'];
 $que="select * from san_pham where id=$id";
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                      ...
                      <li><a  href="danhsachtintuc.php">Danh Sách Tin Tưc</a>
                        </li>
                    </ul>
...
?>  
                ...
                <form acction="addsp.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="name" class="form-control" placeholder="" name="txtname" value="<?php echo $item['ten'];?>" >

                    </div>
                    <div class="form-group">
                        <input type="phone" class="form-control" placeholder="Giá Sản Phẩm" name="txtphone" value="<?php echo $item['gia'];?>">
                    </div>
                    
                    <div class="form-group">

                       <input class="btn btn-success" type="file" name="fileupload" id="fileupload" placeholder="">
                      ...
                      <?php 
                        ...
                        if(isset($item['hinhanh']))
                        {
                            ...
                            echo "<img src='../$hinh' class='img-thumbnail ' width='20%'/>";
                            echo "<span class='text-danger' style='font-size:30px;'>Hình Củ Của Bạn <br><br>";
                        }
                       ?>

                    <div class="form-group">
                    <textarea class="form-control" id="exampleFormControlTextarea2" rows="3" placeholder="Nội Dung" name="txtnoidung" ><?php echo $item['noidung'];?> </textarea>
                    </div>
                    <div class="box_btn">
                        <button type="submit" class="btn btn-success" name="ok">Sửa sản phẩm</button>
                    </div>
                </form>
                <?php
	...
	$txthinh=basename( $_FILES["fileupload"]["name"]);
              ...
              //thuc hien update
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    echo "<br>update that bai " . $sql . "<br>" . mysqli_error($conn);
                }
                //ngat ket noi
                mysqli_close($conn);
