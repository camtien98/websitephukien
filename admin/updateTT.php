...
>
                    ...
                    <div class="box_btn">
                        <button type="submit" class="btn btn-success" name="ok">Sửa Tin Tức</button>
                    </div>
                </form>
                <?php
	...
	{  
			...
			{
				$loi["name"]="*Vui lòng nhập Tin Của Bạn.<br />";
			}
			else
			{
			...
			{
				$loi["noidung"]="*Vui lòng nhập tên của bạn.<br />";
			}
			else
			{
	...
	$txthinh=basename( $_FILES["fileupload"]["name"]);
              ...
              //thuc hien update
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    echo "<br>update Tin Tức Thành Công";
                    
                    
                } else {
                    echo "<br>update Tin Tức Thất Bại " . $sql . "<br>" . mysqli_error($conn);
                }
                //ngat ket noi
                mysqli_close($conn);
